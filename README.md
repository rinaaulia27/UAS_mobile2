...
class App04 extends StatelessWidget {
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {
        "Data": (context) => RinaAuliaDataTable(),
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('UAS-RinaAulia (6SIA10)'),
        ),
        body: LoginPage(),
      ),
    );
...
class RinaAuliaDataTable extends StatefulWidget {
  _RinaAuliaDataTableState createState() => _RinaAuliaDataTableState();
}

class _RinaAuliaDataTableState extends State<RinaAuliaDataTable> {
...
class DataMahasiswa {
  ...
  static List<DataMahasiswa> getDataBarang() {
    return <DataMahasiswa>[
      DataMahasiswa(
          id: "Nama", namabarang: "Rina Aulia", ),
      DataMahasiswa(
          id: "Jenis Kelamin", namabarang: "Perempuam", ),
